...
class CaloriesCell: UICollectionViewCell, UITableViewDataSource, UITableViewDelegate {
    
    let cells = ["Calories", "Calories from Fat"]
    ...
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        return nutritionInfo.calorieInfo.count
    }
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let info: String = nutritionInfo.calorieInfo[indexPath.row]
