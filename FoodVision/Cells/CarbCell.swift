...
class CarbCell: UICollectionViewCell, UITableViewDataSource, UITableViewDelegate {
    
    let carbLabel = ["Total Carbs (g)", "Dietary Fiber (g)", "Sugars (g)"]
    ...
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        return nutritionInfo.carbInfo.count
    }
    
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        
        //let text: String = carbLabel[indexPath.row]
        let info: String = nutritionInfo.carbInfo[indexPath.row]
