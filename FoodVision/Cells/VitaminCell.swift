...
//
let nutritionInfo = DataStore.sharedInstance


import UIKit

class VitaminCell: UICollectionViewCell, UITableViewDataSource, UITableViewDelegate {
    
    let vitaminLabel = ["Vitamin A (%)", "Vitamin C (%)", "Calcium (%)", "Iron (%)"]
    ...
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        return nutritionInfo.vitaminInfo.count
    }
    
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        
        //let text: String = vitaminLabel[indexPath.row]
        let info: String = nutritionInfo.vitaminInfo[indexPath.row]
